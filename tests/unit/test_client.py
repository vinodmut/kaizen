...
def test_health_check(kaizen_client: KaizenClient, monkeypatch):
    ...
    def ready(self) -> bool:
        return False
    monkeypatch.setattr(kaizen_client.backend, 'ready', ready.__get__(kaizen_client, BaseCortexBackend))
...
def test_create_namespace(kaizen_client: KaizenClient, monkeypatch):
    ...
    monkeypatch.setattr(kaizen_client.backend, 'create_namespace', create_namespace.__get__(kaizen_client.backend, BaseCortexBackend))
...
def test_get_namespace_details(kaizen_client: KaizenClient, monkeypatch):
    ...
    monkeypatch.setattr(kaizen_client.backend, 'get_namespace_details', get_namespace_details.__get__(kaizen_client.backend, BaseCortexBackend))
...
def test_search_namespaces(kaizen_client: KaizenClient, monkeypatch):
    ...
    monkeypatch.setattr(kaizen_client.backend, 'search_namespaces', search_namespaces.__get__(kaizen_client.backend, BaseCortexBackend))
...
def test_delete_namespace(kaizen_client: KaizenClient, monkeypatch):
    ...
    monkeypatch.setattr(kaizen_client.backend, 'delete_namespace', delete_namespace.__get__(kaizen_client.backend, BaseCortexBackend))
...
def test_update_entities(kaizen_client: KaizenClient, monkeypatch):
    ...
    monkeypatch.setattr(kaizen_client.backend, 'update_entities', update_entities.__get__(kaizen_client.backend, BaseCortexBackend))
...
def test_search_entities(kaizen_client: KaizenClient, monkeypatch):
    ...
    monkeypatch.setattr(kaizen_client.backend, 'search_entities', search_entities.__get__(kaizen_client.backend, BaseCortexBackend))
...
def test_delete_entity(kaizen_client: KaizenClient, monkeypatch):
    ...
    monkeypatch.setattr(kaizen_client.backend, 'delete_entity_by_id', delete_entity_by_id.__get__(kaizen_client.backend, BaseCortexBackend))
